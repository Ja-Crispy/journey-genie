    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="relative min-h-screen flex items-center">
        ...
        <div className="absolute inset-0 bg-cover bg-center z-0" 
             style={{ 
               backgroundImage: "url('https://images.unsplash.com/photo-1500835556837-99ac94a94552?q=80&w=1974&auto=format&fit=crop')", 
               backgroundPosition: "center" 
             }}>
          <div className="absolute inset-0 bg-gradient-to-r from-teal-900/60 to-teal-500/40"></div>
        </div>
        ...
        <div className="container mx-auto px-4 py-12 z-10 flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="w-full lg:w-1/2 text-white space-y-6 animate-fade-in">
            ...
            <p className="text-lg md:text-xl opacity-90 max-w-lg">
              Discover personalized itineraries, hidden gems, and smart budgeting for your next adventure.
            </p>
